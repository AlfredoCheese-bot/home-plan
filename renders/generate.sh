...
gen () {
  local id="$1"; local prompt="$2"; local seed="${3:-$SEED}"
...
gen living  "open living and dining room, sage-green fabric sofa, dark walnut hardwood floor, low cream stone coffee table, round white rice-paper lantern pendants, green moody marble feature wall beside a walnut dry-kitchen counter, full-height walnut cabinetry, wood dining table with black-frame leather chairs, hanging trailing plants, cozy eclectic tiger-print throw; warm low-key layered lighting, hidden LED cove lighting in the ceiling recess and along the floating shelves, under-cabinet warm glow, backlit shoji-style panels, warm pools of 2700K light over the table and sofa, soft indirect ambient light, deep moody shadows, cinematic evening atmosphere" 77
